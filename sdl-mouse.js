...
function SDL_GetMouseState() {
  var posX = ref.alloc('int');
  var posY = ref.alloc('int');
  const bitMask = SDL.SDL_GetMouseState(posX, posY);
  return {
    x: posX.deref(),
    y: posY.deref(),
    bitMask
...
exports.SDL_GetMouseState = SDL_GetMouseState;


exports.SDL_BUTTON_LEFT = 1;
exports.SDL_BUTTON_MIDDLE = 2;
exports.SDL_BUTTON_RIGHT = 3;
exports.SDL_BUTTON = function(X) {
  return 1 << (X - 1);
}

function SDL_ShowCursor(will) {
...
function SDL_CreateSystemCursor(typeMap) {
  return SDL.SDL_CreateSystemCursor(typeMap);
}
