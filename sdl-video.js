...
function SDL_GetWindowDisplayIndex(windowPtr) {
  return SDL.SDL_GetWindowDisplayIndex(windowPtr);
}
exports.SDL_GetWindowDisplayIndex = SDL_GetWindowDisplayIndex;

function SDL_GetDisplayDPI(display = null) {
  var d = ref.alloc('float');
  var h = ref.alloc('float');
  var v = ref.alloc('float');
  SDL.SDL_GetDisplayDPI(display, d, h, v);
  return {
    d: d.deref(),
    h: h.deref(),
    v: v.deref()
...
exports.SDL_GetDisplayDPI = SDL_GetDisplayDPI;
